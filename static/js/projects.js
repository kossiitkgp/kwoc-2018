...
{'title': 'BrkOut', 'id': 12, 'btnid': 1012, 'intro': ' A prison escape game with a blend of brick breaking gameplay and innovative implementation of the same to get the look of an escape.', 'intro_full': ' A prison escape game with a blend of brick breaking gameplay and innovative implementation of the same to get the look of an escape.', 'mentor': 'Shivam Kumar Jha', 'mentor_email': 'shivam.cs.iit.kgp@gmail.com', 'tag': ['Python'], 'link': 'https://github.com/thealphadollar/brkout', 'comm': 'https://gitter.im/brkout_/Lobby', 'img': 'https://github.com/thealphadollar.png?size=50'},
